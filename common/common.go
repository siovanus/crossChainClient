...
func GetAliaAccountByPassword(asdk *asdk.MultiChainSdk, path string) (*asdk.Account, bool) {
...
func GetSideAccountByPassword(sdk *sdk.OntologySdk, path string) (*sdk.Account, bool) {
